<%-- 
    Document   : intAllReports
    Created on : Mar 13, 2023, 4:16:33 PM
    Author     : KHOA
--%>
...
<div class="sidebar">
    ...
    <ul>
        <li><a href="<c:url value="/interviewer/schedules"/>">Schedules List</a></li>
        <li><a class="active" href="<c:url value="/interviewer/reports"/>">Reports List</a></li>
    </ul>
</div>
<div id="wrapper">

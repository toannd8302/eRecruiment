        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><button class="btn btn-success detail-toggle"> <a href="http://localhost:8084/WebProject/job/application?data=<%=j.getPostId()%>"/>Apply Now</a></button></td>
                    <td><button class="btn btn-danger detail-toggle" style="height: 3.2rem;">
                            <a href="http://localhost:8084/WebProject/post-detail/view/delete/<%=j.getPostId()%>" style="text-decoration: none; color: #fff; ">Unsave</a>
                        </button></td>
                </tr>
                <%
                    }%>

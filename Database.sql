...
INSERT Job_positions(Job_id, JobName, Department_id)
    VALUES(N'J0023', N'Social Media Specialist', N'MA')
INSERT Job_positions(Job_id, JobName, Department_id)
    VALUES(N'J0024', N'SEO specialist', N'MA')
INSERT Job_positions(Job_id, JobName, Department_id)
    VALUES(N'J0025', N'Brand ambassadorr', N'MA')
--Hanh Chinh
INSERT Job_positions(Job_id, JobName, Department_id)
...
INSERT Job_positions(Job_id, JobName, Department_id)
    VALUES(N'J0022', N'Financial Analyst', N'KT')
...
INSERT Job_postings(Post_id, Descriptions, Type_of_work, Locations, Welfare, Salary, Created_time, Posting_time, Expired_time, Approved_status, Level, Picture, Job_id)
	...
	'1', N'Q.2',N'Annual voluntary health insurance;Social insurance;Yearly company trip','2000', N'2023-1-29', N'2023-2-4', N'2023-3-31',N'Approved', N'Junior', N'https://dotnet.microsoft.com/static/images/redesign/social/square.png','J0003' )
INSERT Job_postings(Post_id, Descriptions, Type_of_work, Locations, Welfare, Salary, Created_time, Posting_time, Expired_time, Approved_status, Level, Picture, Job_id)
	...
	'0', N'Q.9',N'Salary raises or bonus by work performance per 12 months;All insurances according to Vietnamese Labor law','3000', N'2022-12-15', Null, Null, N'Pending', N'Senior', N'https://dotnet.microsoft.com/static/images/redesign/social/square.png','J0004' )
...
INSERT Job_Applications(Application_id, Created_time, CV, CV_status, Round_number, Application_status, Introduction, Candidate_id, Post_id)
	VALUES (N'A0001', N'2022-12-25',N'sfsdfdsfsd', N'Approved', '2', N'Scheduled', N'I was the editor of the yearly periodical at Miranda House and also completed two internships at Caravan and The Indian Express. I was excited to find this position as an Assistant Editor at your organisation and I believe I would be a great fit for this role.', 
	N'CA0001', N'P0001')
INSERT Job_Applications(Application_id, Created_time, CV, CV_status, Round_number, Application_status, Introduction, Candidate_id, Post_id)
	VALUES (N'A0002', N'2023-3-13', N'sdfsdvcxv', N'Pending', Null, N'Review', N'Being a certified professional, I have pursued BTech in Computer Science Engineering with a specialization in Networking and Security from VIT Vellore. I have recently appeared for the CCNA certification examination and I am awaiting the result.', 
	N'CA0002', N'P0003')
INSERT Job_Applications(Application_id, Created_time, CV, CV_status, Round_number, Application_status, Introduction, Candidate_id, Post_id)
	VALUES (N'A0003', N'2022-1-9', N'sdfsdfcxvc', N'Approved', Null, N'On Going', N'I was a part of the SEO Marketing team at Leverage Edu for the last 2 years and before that, I worked for a year at Infinity Inc. I have a thorough knowledge of on-page and off-page SEO as well as content marketing tools.', 
	N'CA0003', N'P0004')
INSERT Job_Applications(Application_id, Created_time, CV, CV_status, Round_number, Application_status, Introduction, Candidate_id, Post_id)
	VALUES (N'A0004', N'2022-1-9', N'sdfsdfdsf', N'Approved', Null, N'Scheduling', N'I was a part of the SEO Marketing team at Leverage Edu for the last 2 years and before that, I worked for a year at Infinity Inc. I have a thorough knowledge of on-page and off-page SEO as well as content marketing tools.', 
	N'CA0004', N'P0004')
INSERT Job_Applications(Application_id, Created_time, CV, CV_status, Round_number, Application_status, Introduction, Candidate_id, Post_id)
	VALUES (N'A0005', N'2022-1-9', N'kj23hkjrhkr', N'Rejected', Null, N'Fail', N'I was a part of the SEO Marketing team at Leverage Edu for the last 2 years and before that, I worked for a year at Infinity Inc. I have a thorough knowledge of on-page and off-page SEO as well as content marketing tools.', 
	N'CA0003', N'P0001')
...
INSERT Skills(Skill_id, SKillName)
    VALUES(N'15', N'Git')
INSERT Skills(Skill_id, SKillName)
	VALUES(N'27',N'TestNG')

--Soft Skills
INSERT Skills(Skill_id, SKillName)
	VALUES(N'16',N'Communication Skills')
INSERT Skills(Skill_id, SKillName)
	VALUES(N'17',N'Data Analysis Skills')
INSERT Skills(Skill_id, SKillName)
	VALUES(N'18',N'Critical Thinking')
INSERT Skills(Skill_id, SKillName)
	VALUES(N'19',N'Problem-solving Skills')
INSERT Skills(Skill_id, SKillName)
	VALUES(N'20',N'Statistical analysis')
INSERT Skills(Skill_id, SKillName)
	VALUES(N'21',N'Teamwork')
INSERT Skills(Skill_id, SKillName)
	VALUES(N'22',N'Organization and Time Management')
INSERT Skills(Skill_id, SKillName)
	VALUES(N'23', N'Leadership')	
INSERT Skills(Skill_id, SKillName)
	VALUES(N'24', N'Good Listening')
INSERT Skills(Skill_id, SKillName)
	VALUES(N'25', N'Analysis Skills')
INSERT Skills(Skill_id, SKillName)
	VALUES(N'26', N'Analytical Skills')
INSERT Skills(Skill_id, SKillName)
	VALUES(N'28', N'Adaptability')
INSERT Skills(Skill_id, SKillName)
	VALUES(N'29', N'Creativity')
